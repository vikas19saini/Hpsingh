...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '93c101e00a8407c73189796e4c76626125b3f0e36b4a49d41a5f7d3a651dfeff'),
    ],
    /**
    ...
    'OrderStatus' => [
        'pending-payment' => 'Pending payment', //Order received, no payment initiated. Awaiting payment (unpaid).
        ...
        'processing' => 'Processing', // Payment received (paid) and stock has been reduced; order is awaiting fulfillment.
        'shipped' => 'Shipped',
        'completed' => 'Completed', // Order fulfilled and complete – requires no further action.
        'on-hold' => 'On-Hold', // Awaiting payment – stock is reduced, but you need to confirm payment.
