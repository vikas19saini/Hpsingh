                            ...
                            <tr>
                                <td>
                                    <?php if (isset($product->featured_image)) : ?>
                                        <?= $this->Media->the_image('thumbnail', $product->featured_image->url, ['width' => '100px']) ?>
                                    <?php else : ?>
                ...
                <?php if (!empty($order->order_history)) : foreach ($order->order_history as $history) : ?>
                        <div class="order_note">
                            <div class="note_details">
                                ...
                                <p>Is Private: <i><?= ucwords($history->is_private) ?></i></p>
                                <hr />
                                <p><?= $history->comment ?></p>
                            </div>
                    ...
                    <?php foreach ($order->payments as $payment) : ?>
                        ...
                        <?php if (strtolower($payment->payment_method) === 'payu') : ?>
                            <div class="payment-details">
                                <?php $details = json_decode($payment->details);
