          ...
          <?= $this->Element('customer/navigation')?>
                ...
                <div class="orders_area active">
                    <div class="orders_top">
                        ...
                        <div><p>Ordered On: <em><?= date_format($order_details->created, 'd M, Y')?></em></p></div>
                  ...
                  <?php foreach ($order_details->products as $product):?>
                        <div class="order_view">
                            ...
                            <div>
                                ...
                                <p>Price: <price><?= empty($product->_joinData->sale_price) ? $this->Number->currency($product->_joinData->price, $order_details->currency_code) : $this->Number->currency($product->_joinData->sale_price, $order_details->currency_code) . ' <del>' . $this->Number->currency($product->_joinData->price, $order_details->currency_code) . '</del>'?></price></p>
                            </div>
                        </div>
                  <?php endforeach;?>
                    </div>
                            ...
                            <div class="price_break">
                                ...
                                <div class="tooltiptext">
                                    <table>
                                        <tr>
                                            <td>Total Amount: </td>
                                            <td><price><?= $this->Number->currency($order_details->total_price, $order_details->currency_code)?></price></td>
                                        </tr>
                                        
                                        <?php if(!empty($order_details->discount)):?>
                                        <tr>
                                            <td>Discount: </td>
                                            <td><price><?= $this->Number->currency($order_details->discount, $order_details->currency_code)?></price></td>
                                        </tr>
                                        <?php endif;?>
                                        ...
                                        <tr>
                                            ...
                                            <td><price><?= $this->Number->currency($order_details->coupon_discount, $order_details->currency_code)?></price></td>
                                        </tr>
                                        <?php endif;?>
                                        ...
                                        <tr>
                                            ...
                                            <td><price><?= $this->Number->currency($order_details->tax_charges, $order_details->currency_code)?></price></td>
                                        </tr>
                                        <?php endif;?>
                                        ...
                                        <tr>
                                            <td>Shipping: </td>
                                            <td><price><?= $this->Number->currency($order_details->shipping_charges, $order_details->currency_code)?></price></td>
                                        </tr>
                                        <?php endif;?>
                                        ...
                                        <tr>
                                            <td>Cod Charges: </td>
                                            <td><price><?= $this->Number->currency($order_details->cod_charges, $order_details->currency_code)?></price></td>
                                        </tr>
                                        <?php endif;?>
                                        
                                        <tr>
                                            <td>Total Due: </td>
                                            <td><price><?= $this->Number->currency($order_details->grand_total, $order_details->currency_code)?></price></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        </div>
                        <div><p>Payment Mode: <?= $order_details->payment_mode?></p></div>
                    </div>
                </div>         
            </div>
        </div>
