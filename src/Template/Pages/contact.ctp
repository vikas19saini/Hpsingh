    ...
    <section class="enquiry contact-form">
        <div class="container">
            <div class="row">
                ...
                <ul>
                    <li class="contact_form_btn active">LEAVE US A COMMENT</li>
                ...
                <div class="enquiry_form active">
                    <?= $this->Form->create($contact, ['url' => ['controller' => 'pages', 'action' => 'save', $this->request->getParam('slug')], 'type' => 'file'])?>
                        ...
                        <div class="form-group">
                            <?= $this->Form->control('req_type', ['label' => false, 'options' => ['Order Related' => 'Order Related', 'Bulk Order' => 'Bulk Order', 'Other' => 'Other']])?>
                        </div>
