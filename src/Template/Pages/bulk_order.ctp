    ...
    <section class="enquiry contact-form">
        <div class="container">
            <div class="row">
                ...
                <ul>
                    <li class="contact_form_btn active">Looking for Bulk/Wholesale?</li>
                ...
                <div class="enquiry_form active">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                            <?= $this->Form->control('req_type', ['label' => false, 'type' => 'number', 'min' => 25, 'max' => 500, 'placeholder' => 'Enter quantity'])?>
                            </div>
