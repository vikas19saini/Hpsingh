                    ...
                    <tr>
                        <td>
                            <table align="center" style="border:1px solid #FFAE5F;" width="100%">
                                <tr>
                                    <td width="75%">
                                        <p class="product">Product Details</p>
                                    </td>
                                    <td width="25%">
                                        <p class="product" style="padding-left:4px">Price</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td width="200px">
                                                            <div class="img_tx">
                                                                <p>
                                                                <p><?= $cartDetails['products'][0][$product->id]['qty'] ?></p>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="33%">
                                            <div class="product_ft">
                                                <p>
                                                    <a style="color:#fff" href="https://www.hpsingh.com">Continue Shopping</a>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
